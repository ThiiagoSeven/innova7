...
<div class="container col-xl-6 col-xxl-4 px-4 py-1">
  ...
  <div class="py-5 py-lg-12">
                               <div class="container">
                                  ...
                                  <div class="row">
                                          ...
                                          <div class="grayscale mb-6 text-center">
                                          ...
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-airbnb.svg" alt="" class="grayscale">
                                          </div>
                                          </div>
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-netflix.svg" alt="" class="grayscale">
                                          </div>
                                          </div>
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img class="grayscale" src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-pinterest.svg" alt=" ">
                                          </div>
                                          </div>
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-discord.svg" alt="" class="grayscale">
                                          </div>
                                          </div>
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-intercom.svg" alt="" class="grayscale">
                                          </div>
                                          </div>
                                          <div class="col-lg-2 col-md-4 col-6">
                                          <div class="mb-6 text-center">
                                             <img src="https://codescandy.com/geeks-bootstrap-5/assets/images/brand/gray-logo-stripe.svg" alt="" class="grayscale">
                                          </div>
                                          </div>
                                  </div>
                               </div>
  ...
  <div class="container-fluid" id="artigos">
  Seção 4
  </div>
